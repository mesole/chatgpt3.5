...
export default () => {
  ...
  const requestWithLatestMessage = async () => {
    ...
    try {
      ...
      // const response = await fetch('http://52.78.38.136:8080/chat3?content='+encodeURIComponent(JSON.stringify( requestMessageList )), {
      ...
      >
        <div class="my-4 flex items-center gap-2 transition-opacity" class:op-50={systemRoleEditing()}>
          <textarea
            ...
            scroll-pa-8px
          />
          <button onClick={handleButtonClick} disabled={systemRoleEditing()} h-12 px-4 py-1 bg-slate bg-op-15 hover:bg-op-20 rounded-sm><p style="font-size: 13px;width:30px;">发送</p></button>
